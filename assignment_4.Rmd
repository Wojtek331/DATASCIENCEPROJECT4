...
The value means the GDP per capita in 1960, converted to 1960 US dollars, 
...
library(officer)
data(GrowthSW)
flex_tbl <- flextable(GrowthSW)
doc <- read_docx()
doc <- body_add_flextable(doc, value = flex_tbl)
print(doc, target = "GrowthSW_Table.docx")
```
